...
class CNaverBlog
{
	...
	public function fetchCategory($blogId)
	{
		...
		$pageinfo	= $json->decode($__s->results);
	...
	public function fetchBlogCategoryToId($id)
	{
		...
		echo iconv('CP949', 'UTF-8', 'ë‚™ì„œìž¥');
		...
		while($get_content_1[$i])
		{
			...
			//echo iconv('CP949', 'UTF-8', $CObject->getCategoryName());
	...
	public function fetchContentsToId($id) // naver id에 해당하는 모든 블로그 컨텐츠 정를 끌고 온다. 
	{
